...
abstract class ColorManager {
  ...
  static Color backgroundSecondary =
      HexColor.fromHex("#E4F1F8"); // Light blue from Figma
  static Color backgroundTertiary =
      HexColor.fromHex("#F8FAFC"); // Very light grey

  // Surface Colors
  static Color surface = HexColor.fromHex("#FFFFFF"); // Card/surface background
  static Color surfaceVariant =
      HexColor.fromHex("#F1F5F9"); // Alternative surface
  static Color surfaceContainer =
      HexColor.fromHex("#E2E8F0"); // Container background

  // Text Colors - From Figma Design
  static Color textPrimary =
      HexColor.fromHex("#060302"); // Main text from Figma
  static Color textSecondary =
      HexColor.fromHex("#767372"); // Secondary text from Figma
  static Color textTertiary = HexColor.fromHex("#94A3B8"); // Tertiary/hint text
  static Color textOnPrimary =
      HexColor.fromHex("#FFFFFF"); // Text on primary color

  // On-Color Text (for text on colored backgrounds)
  static Color onPrimary =
      HexColor.fromHex("#FFFFFF"); // Text on primary background
  static Color onSecondary =
      HexColor.fromHex("#FFFFFF"); // Text on secondary background
  static Color onSurface =
      HexColor.fromHex("#060302"); // Text on surface background
  static Color onSuccess =
      HexColor.fromHex("#FFFFFF"); // Text on success background
  static Color onWarning =
      HexColor.fromHex("#FFFFFF"); // Text on warning background
  static Color onError =
      HexColor.fromHex("#FFFFFF"); // Text on error background

  // Semantic Colors
  static Color success =
      HexColor.fromHex("#10B981"); // Success/positive actions
  ...
  static Color info =
      HexColor.fromHex("#3787FF"); // Information states (using primary)

  // Onboarding Colors - Updated to use Figma colors
  static Color onboardingPrimary =
      HexColor.fromHex("#3787FF"); // Use primary blue
  static Color onboardingSecondary =
      HexColor.fromHex("#10B981"); // Use secondary green
  static Color onboardingAccent =
      HexColor.fromHex("#F59E0B"); // Orange accent for highlights
  ...
  static Color borderFocus =
      HexColor.fromHex("#3787FF"); // Focused border (using primary)
  ...
  static Color secondry =
      secondary; // Keep typo for compatibility, point to new secondary
  ...
  static Color blackText = textPrimary;
}
